...
export const SkullIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M12 2a7 7 0 0 0-7 7v3c0 .8.3 1.6.8 2.1l1.2 1.2v3c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2v-3l1.2-1.2c.5-.5.8-1.3.8-2.1V9a7 7 0 0 0-7-7z" />
    <path d="M10 16h4" />
  </svg>
);
...
export const ChainIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BuildingIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const RocketIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  ...
  >
    ...
    <path d="M12 12c-2 2-5 3-7 3s1-5 3-7c2-2 5-3 7-3s-1 5-3 7z" />
    <path d="M14 8l-2-2M18 10l2 2M16 6l5-5-5 5" />
  </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  ...
  >
    ...
    <path d="M5 7L2 17c0 1.5 2 2 3 2s3-.5 3-2L5 7z" />
    <path d="M19 7l-3 10c0 1.5 2 2 3 2s3-.5 3-2l-3-10z" />
  </svg>
);
...
export const WalletIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H9" />
  </svg>
);
